...
function useRouterPrefetch(url, observe, nextRouterPrefetchOptions) {
    ...
    var prefetchLink = function () {
        if (typeof url === "string") {
            ...
            var _a = prepareUrlAs_1.prepareUrlAs(router, url, nextRouterPrefetchOptions === null || nextRouterPrefetchOptions === void 0 ? void 0 : nextRouterPrefetchOptions.as), prefetchUrl = _a.url, prefetchAs = _a.as;
            return {
